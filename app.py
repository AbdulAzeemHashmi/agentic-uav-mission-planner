...
st.sidebar.caption("Agentic UAV Mission Center v1.0")
st.sidebar.write("---")
...
if st.session_state.current_page == "Home":
    ...
    <div class="hero-banner">
        <h1 class="hero-title">🛸 SkyGuard AI UAV Assistant</h1>
        <p class="hero-subtitle">
            An advanced Agentic UAV Mission Planner & Safety Compliance tool. Convert natural language parameters into structured, compliant flight paths, visualize on interactive geofence maps, and run fail-safe rule checking dynamically.
        </p>
    </div>
    """, unsafe_allow_html=True)
